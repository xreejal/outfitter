...
export default function ItemPickerModal({ open, onClose, items, onSelect, products }: Props) {
      ...
      <div className="absolute inset-0 bg-white flex flex-col z-10">
        ...
        <div className="flex-1 overflow-y-auto p-4">
          {(!products || products.length === 0) && items.length === 0 ? (
            <div className="text-center text-sm text-gray-500">No items yet—still loading?</div>
          ) : (
